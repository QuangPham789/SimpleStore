...
var (
	productAllColumns            = []string{"id", "code", "name", "description", "category", "price", "created_at"}
	productColumnsWithoutDefault = []string{"code", "name"}
	productColumnsWithDefault    = []string{"id", "description", "category", "price", "created_at"}
...
func (o *Product) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("dbmodels: no Product provided for reload")
	}
...
func (o *ProductSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("dbmodels: empty ProductSlice provided for reload all")
	}
